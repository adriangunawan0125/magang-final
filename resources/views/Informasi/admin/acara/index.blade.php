...
<body>
    <div class="container">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($acara->foto)
                                <img src="{{ asset('storage/' . $acara->foto) }}" alt="Gambar" style="max-height: 100px;">
                            @else
                        ...
                        <td>
                            <div class="action">
                                <a href="{{ route('admin.acara_informasi.edit', $acara->id) }}" class="btn btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="{{ route('admin.acara_informasi.destroy', $acara->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                    @csrf
                                    @method('DELETE')
        ...
        <div style="margin-top: 20px;" class="action">
            <a href="{{ route('admin.acara_informasi.create') }}" class="btn btn-add">

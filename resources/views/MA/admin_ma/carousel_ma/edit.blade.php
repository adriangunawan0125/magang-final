...
<head>
    ...
    <title>Edit Gambar Carousel MA</title>
...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('admin.carousel_ma.update', $carousel->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="btn-container">
                ...
                <a href="{{ route('admin.carousel_ma.index') }}" class="btn btn-cancel">
                    Batal
                </a>
            </div>
        </form>

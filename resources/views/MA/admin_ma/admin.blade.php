...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
        <!-- Tombol Kembali -->
        <a href="{{ route('ma.index') }}" class="out-btn btn btn-back">
    ...
    <div id="carouselExampleCaptions" class="carousel slide position-relative" data-bs-ride="carousel">
        ...
        <a href="{{ route('admin.carousel_ma.index') }}" class="btn btn-edit">Ubah Gambar</a>
    ...
    <div class="sambutan-container">
        ...
        <a href="{{ route('admin.sambutan.edit', ['sambutan' => $sambutan->id]) }}"><button>edit</button></a>

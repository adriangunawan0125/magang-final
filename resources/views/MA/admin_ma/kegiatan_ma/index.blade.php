...
<body>
    <div class="container">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.kegiatan_ma.edit', $kegiatan->id) }}" class="btn btn-edit">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="{{ route('admin.kegiatan_ma.destroy', $kegiatan->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
        ...
        <div style="margin-top: 20px;">
            <a href="{{ route('admin.kegiatan_ma.create') }}" class="btn btn-add">

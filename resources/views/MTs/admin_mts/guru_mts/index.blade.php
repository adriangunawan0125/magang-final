...
<body>
    ...
    <div class="container">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action" style="display: flex; align-items: center; justify-content: center;">
                                <a href="{{ route('admin.guru_mts.edit', $g->id) }}" class="btn btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="{{ route('admin.guru_mts.destroy', $g->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                    @csrf
                                    @method('DELETE')
        ...
        <div style="margin-top: 20px;">
            <a href="{{ route('admin.guru_mts.create') }}" class="btn btn-add">

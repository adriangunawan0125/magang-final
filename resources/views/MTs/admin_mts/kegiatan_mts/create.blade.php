...
<head>
    ...
    <title>Tambah Kegiatan MTS</title>
...
<body>
    <div class="container">
        <h2>Tambah</h2>
        <form action="{{ route('admin.kegiatan_mts.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="btn-group">
                ...
                <a href="{{ route('admin.kegiatan_mts.index') }}" class="btn btn-danger">Kembali</a>
            </div>
        </form>
    </div>
</body>
